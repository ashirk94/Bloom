...
function applyValues() {
  if (document.getElementById("value1-container").firstElementChild) {
    value1Submit.value =
      document.getElementById("value1-container").firstElementChild.textContent;
  }
  if (document.getElementById("value2-container").firstElementChild) {
    value2Submit.value =
      document.getElementById("value2-container").firstElementChild.textContent;
  }
  if (document.getElementById("value3-container").firstElementChild) {
    value3Submit.value =
      document.getElementById("value3-container").firstElementChild.textContent;
  }
  if (document.getElementById("value4-container").firstElementChild) {
    value4Submit.value =
      document.getElementById("value4-container").firstElementChild.textContent;
  }
  if (document.getElementById("value5-container").firstElementChild) {
    value5Submit.value =
      document.getElementById("value5-container").firstElementChild.textContent;
  }
}
